...
function GlowBackdrop() {
    const geometry = useMemo(() => new THREE.SphereGeometry(10, 32, 32), [])
    const material = useMemo(
        () =>
            new THREE.MeshBasicMaterial({
                color: new THREE.Color('#f6efe4'),
                transparent: true,
                opacity: 0.28,
                side: THREE.BackSide,
            }),
    ...
    return <mesh geometry={geometry} material={material} scale={[1.6, 1, 1]} position={[0, 0.2, -1]} />
}
...
function SceneContents() {
    return (
        <>
            ...
            <GlowBackdrop />
            <pointLight position={[5, 5, 5]} intensity={1.2} color="#3b9eff" />
            <pointLight position={[-5, -3, 3]} intensity={0.8} color="#11ff99" />
            <pointLight position={[0, 3, -2]} intensity={0.6} color="#ff801f" />
